           ...
           <img src="img/Gray_Multiply (1).png" width="12px"  onClick="cancelbooking()" class="cancel_booking"/>
            ...
            <form method="POST" action="service/room/savebooking-dates.php">
                <table class="tbl_savebokking">
                 <tr>
                    <td>Starting Date:</td>
                    <td><input type="datetime-local" name="admit_date"/></td><br/><br/>
                </tr>
                <tr>
                        <td>Leaving Date:</td>
                        <td><input type="datetime-local" name="discharge_date"/></td><br/>
                </tr>
                <tr>
                        <td>Room no:</td>
                ...
                <input type="submit" value="Save" class="save-booking" name="save" />
                </form>
        </div>
